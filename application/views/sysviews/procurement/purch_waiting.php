<table id="purchWait" class="table table-stripped table-hover datatable dashboard_table data_grid1">
    <caption class="view_tables tb-header-custom"><h5>Waiting Purchase Requisitions</h5></caption>
