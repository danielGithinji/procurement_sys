...
<div class="alert alert-info" style="margin: 10px 20px 30px 20px; width:91%;">  
    ...
    <p>This is the <?php echo $department; ?> department dashboard. Below is the quick access panel. Click any of the
...
<div id="edit_ui" class="proc_dash" >
    ...
    <div id="site_nav">
        ...
        <a href="<?php echo base_url(); ?>site_nav/mat_req_form" class="metro-tile" ><i class="icon-edit icon-size"></i><br/>Make Requisition</a>
        <a href="<?php echo base_url(); ?>site_nav/view_mat_req" class="metro-tile" style="background-color: #a463e2"><i class="icon-eye-open icon-size" ></i><br/>View Requisitions</a>
...
<div>
    ...
    <div id="edit_ui" class="proc_dash" style="background-color: #e9f6f4;">
        ...
        <div id="load_calendar">
            <?php $this->load->view('sysviews/user_dept/cal_view'); ?>
        </div>
    </div>
</div>
